lib_mg_valleys_2d = {}
lib_mg_valleys_2d.name = "lib_mg_valleys_2d"
lib_mg_valleys_2d.ver_max = 0
lib_mg_valleys_2d.ver_min = 1
lib_mg_valleys_2d.ver_rev = 0
lib_mg_valleys_2d.ver_str = lib_mg_valleys_2d.ver_max .. "." .. lib_mg_valleys_2d.ver_min .. "." .. lib_mg_valleys_2d.ver_rev
lib_mg_valleys_2d.authorship = "ShadMOrdre.  Additional credits to Termos' Islands mod; Gael-de-Sailleys' Valleys; duane-r Valleys_c, burli mapgen, and paramats' mapgens"
lib_mg_valleys_2d.license = "LGLv2.1"
lib_mg_valleys_2d.copyright = "2020"
lib_mg_valleys_2d.path_mod = minetest.get_modpath(minetest.get_current_modname())
lib_mg_valleys_2d.path_world = minetest.get_worldpath()
...
if minetest.get_modpath("intllib") then
	...
	S, NS = dofile(lib_mg_valleys_2d.path_mod.."/intllib.lua")
end
lib_mg_valleys_2d.intllib = S

minetest.log(S("[MOD] lib_mg_valleys_2d:  Loading..."))
minetest.log(S("[MOD] lib_mg_valleys_2d:  Version:") .. S(lib_mg_valleys_2d.ver_str))
minetest.log(S("[MOD] lib_mg_valleys_2d:  Legal Info: Copyright ") .. S(lib_mg_valleys_2d.copyright) .. " " .. S(lib_mg_valleys_2d.authorship) .. "")
minetest.log(S("[MOD] lib_mg_valleys_2d:  License: ") .. S(lib_mg_valleys_2d.license) .. "")
	...
	lib_mg_valleys_2d.heightmap = {}
	lib_mg_valleys_2d.fillermap = {}
	lib_mg_valleys_2d.biomemap = {}
	lib_mg_valleys_2d.rivermap = {}
	lib_mg_valleys_2d.surfacemap = {}
	lib_mg_valleys_2d.slopemap = {}

	mapgen = {}
	mapgen.heightmap = lib_mg_valleys_2d.heightmap
	mapgen.biomemap = lib_mg_valleys_2d.biomemap

	lib_mg_valleys_2d.water_level = 1
	lib_mg_valleys_2d.mgvalleys_river_size = 5
	-- mg_dim = 2d, 3d
	lib_mg_valleys_2d.mg_dim = "2d"

	lib_mg_valleys_2d.use_heat_scalar = false

	lib_mg_valleys_2d.mg_world_scale = 1

	--lib_mg_valleys_2d.mg_noise_spread = 600
	--lib_mg_valleys_2d.mg_noise_scale = 25
	--lib_mg_valleys_2d.mg_noise_lacunarity = 2.19
	--lib_mg_valleys_2d.mg_noise_seed = 5934
	----lib_mg_valleys_2d.mg_noise_offset = 0
	--lib_mg_valleys_2d.mg_noise_offset = -4
	--lib_mg_valleys_2d.mg_noise_octaves = 8
	--lib_mg_valleys_2d.mg_noise_persist = 0.3
	--lib_mg_valleys_2d.mg_noise_lacunarity = 2.19

	--lib_mg_valleys_2d.mg_noise_spread = 512
	--lib_mg_valleys_2d.mg_noise_scale = 25
	--lib_mg_valleys_2d.mg_noise_seed = 5202
	----lib_mg_valleys_2d.mg_noise_offset = 0
	--lib_mg_valleys_2d.mg_noise_offset = -5
	--lib_mg_valleys_2d.mg_noise_octaves = 6
	--lib_mg_valleys_2d.mg_noise_persist = 0.4
	--lib_mg_valleys_2d.mg_noise_lacunarity = 2

	lib_mg_valleys_2d.mg_noise_spread = 1024
	lib_mg_valleys_2d.mg_noise_scale = 50
	lib_mg_valleys_2d.mg_noise_seed = 5202
	--lib_mg_valleys_2d.mg_noise_offset = 0
	lib_mg_valleys_2d.mg_noise_offset = -10
	lib_mg_valleys_2d.mg_noise_octaves = 6
	lib_mg_valleys_2d.mg_noise_persist = 0.4
	lib_mg_valleys_2d.mg_noise_lacunarity = 2
...
--]]
	local np_val_terrain = {
		offset = lib_mg_valleys_2d.mg_noise_offset,
		scale = lib_mg_valleys_2d.mg_noise_scale * lib_mg_valleys_2d.mg_world_scale,
		seed = lib_mg_valleys_2d.mg_noise_seed,
		spread = {x = (lib_mg_valleys_2d.mg_noise_spread * lib_mg_valleys_2d.mg_world_scale), y = (lib_mg_valleys_2d.mg_noise_spread * lib_mg_valleys_2d.mg_world_scale), z = (lib_mg_valleys_2d.mg_noise_spread * lib_mg_valleys_2d.mg_world_scale)},
		octaves = lib_mg_valleys_2d.mg_noise_octaves,
		persist = lib_mg_valleys_2d.mg_noise_persist,
		lacunarity = lib_mg_valleys_2d.mg_noise_lacunarity,
		flags = "defaults",
	}
	local np_val_river = {
		flags = "defaults",
...
--##	
	...
	lib_mg_valleys_2d.biome_info = {}

	for name, desc in pairs(minetest.registered_biomes) do

		if desc then

			lib_mg_valleys_2d.biome_info[desc.name] = {}

			lib_mg_valleys_2d.biome_info[desc.name].b_name = desc.name
			lib_mg_valleys_2d.biome_info[desc.name].b_cid = minetest.get_biome_id(name)

			lib_mg_valleys_2d.biome_info[desc.name].b_top = c_dirtgrass
			lib_mg_valleys_2d.biome_info[desc.name].b_top_depth = 1
			lib_mg_valleys_2d.biome_info[desc.name].b_filler = c_dirt
			lib_mg_valleys_2d.biome_info[desc.name].b_filler_depth = 4
			lib_mg_valleys_2d.biome_info[desc.name].b_stone = c_stone
			lib_mg_valleys_2d.biome_info[desc.name].b_water_top = c_water
			lib_mg_valleys_2d.biome_info[desc.name].b_water_top_depth = 1
			lib_mg_valleys_2d.biome_info[desc.name].b_water = c_water
			lib_mg_valleys_2d.biome_info[desc.name].b_river = c_river
			----lib_mg_valleys_2d.biome_info[desc.name].b_riverbed = c_gravel
			----lib_mg_valleys_2d.biome_info[desc.name].b_riverbed_depth = 2
			----lib_mg_valleys_2d.biome_info[desc.name].b_cave_liquid = c_lava
			----lib_mg_valleys_2d.biome_info[desc.name].b_dungeon = c_mossy
			----lib_mg_valleys_2d.biome_info[desc.name].b_dungeon_alt = c_brick
			----lib_mg_valleys_2d.biome_info[desc.name].b_dungeon_stair = c_block
			----lib_mg_valleys_2d.biome_info[desc.name].b_node_dust = c_air
			lib_mg_valleys_2d.biome_info[desc.name].vertical_blend = 0
			lib_mg_valleys_2d.biome_info[desc.name].min_pos = {x=-31000, y=-31000, z=-31000}
			lib_mg_valleys_2d.biome_info[desc.name].max_pos = {x=31000, y=31000, z=31000}
			lib_mg_valleys_2d.biome_info[desc.name].b_miny = -31000
			lib_mg_valleys_2d.biome_info[desc.name].b_maxy = 31000
			lib_mg_valleys_2d.biome_info[desc.name].b_heat = 50
			lib_mg_valleys_2d.biome_info[desc.name].b_humid = 50
		

			if desc.node_top and desc.node_top ~= "" then
				lib_mg_valleys_2d.biome_info[desc.name].b_top = minetest.get_content_id(desc.node_top) or c_dirtgrass
			end

			if desc.depth_top then
				lib_mg_valleys_2d.biome_info[desc.name].b_top_depth = desc.depth_top or 1
			end

			if desc.node_filler and desc.node_filler ~= "" then
				lib_mg_valleys_2d.biome_info[desc.name].b_filler = minetest.get_content_id(desc.node_filler) or c_dirt
			end

			if desc.depth_filler then
				lib_mg_valleys_2d.biome_info[desc.name].b_filler_depth = desc.depth_filler or 4
			end

			if desc.node_stone and desc.node_stone ~= "" then
				lib_mg_valleys_2d.biome_info[desc.name].b_stone = minetest.get_content_id(desc.node_stone) or c_stone
			end

			if desc.node_water_top and desc.node_water_top ~= "" then
				lib_mg_valleys_2d.biome_info[desc.name].b_water_top = minetest.get_content_id(desc.node_water_top) or c_water
			end

			if desc.depth_water_top then
				lib_mg_valleys_2d.biome_info[desc.name].b_water_top_depth = desc.depth_water_top or 1
			end

			if desc.node_water and desc.node_water ~= "" then
				lib_mg_valleys_2d.biome_info[desc.name].b_water = minetest.get_content_id(desc.node_water) or c_water
			end
			if desc.node_river_water and desc.node_river_water ~= "" then
				lib_mg_valleys_2d.biome_info[desc.name].b_river = minetest.get_content_id(desc.node_river_water) or c_river
			end

--[[
			if desc.node_riverbed and desc.node_riverbed ~= "" then
				lib_mg_valleys_2d.biome_info[desc.name].b_riverbed = minetest.get_content_id(desc.node_riverbed)
			end

			if desc.depth_riverbed then
				lib_mg_valleys_2d.biome_info[desc.name].b_riverbed_depth = desc.depth_riverbed or 2
			end

			if desc.node_cave_liquid and desc.node_cave_liquid ~= "" then
				lib_mg_valleys_2d.biome_info[desc.name].b_cave_liquid = minetest.get_content_id(desc.node_cave_liquid)
			end

			if desc.node_dungeon and desc.node_dungeon ~= "" then
				lib_mg_valleys_2d.biome_info[desc.name].b_dungeon = minetest.get_content_id(desc.node_dungeon)
			end

			if desc.node_dungeon_alt and desc.node_dungeon_alt ~= "" then
				lib_mg_valleys_2d.biome_info[desc.name].b_dungeon_alt = minetest.get_content_id(desc.node_dungeon_alt)
			end

			if desc.node_dungeon_stair and desc.node_dungeon_stair ~= "" then
				lib_mg_valleys_2d.biome_info[desc.name].b_dungeon_stair = minetest.get_content_id(desc.node_dungeon_stair)
			end

			if desc.node_dust and desc.node_dust ~= "" then
				lib_mg_valleys_2d.biome_info[desc.name].b_node_dust = minetest.get_content_id(desc.node_dust)
			end
--]]
			if desc.vertical_blend then
				lib_mg_valleys_2d.biome_info[desc.name].vertical_blend = desc.vertical_blend or 0
			end

			if desc.y_min then
				lib_mg_valleys_2d.biome_info[desc.name].b_miny = desc.y_min or -31000
			end

			if desc.y_max then
				lib_mg_valleys_2d.biome_info[desc.name].b_maxy = desc.y_max or 31000
			end

			lib_mg_valleys_2d.biome_info[desc.name].min_pos = desc.min_pos or {x=-31000, y=-31000, z=-31000}
			if desc.y_min then
				lib_mg_valleys_2d.biome_info[desc.name].min_pos.y = math.max(lib_mg_valleys_2d.biome_info[desc.name].min_pos.y, desc.y_min)
			end

			lib_mg_valleys_2d.biome_info[desc.name].max_pos = desc.max_pos or {x=31000, y=31000, z=31000}
			if desc.y_max then
				lib_mg_valleys_2d.biome_info[desc.name].max_pos.y = math.min(lib_mg_valleys_2d.biome_info[desc.name].max_pos.y, desc.y_max)
			end

			if desc.heat_point then
				lib_mg_valleys_2d.biome_info[desc.name].b_heat = desc.heat_point or 50
			end

			if desc.humidity_point then
				lib_mg_valleys_2d.biome_info[desc.name].b_humid = desc.humidity_point or 50
			end
	...
	local function get_heat_scalar(z)
		...
		if lib_mg_valleys_2d.use_heat_scalar == true then
			local t_z = abs(z)
			local t_heat = 0
			local t_heat_scale = 0.0071875 
			local t_heat_factor = 0
	
			--local t_heat_mid = ((lib_mg_valleys_2d.mg_map_size * lib_mg_valleys_2d.mg_world_scale) * 0.25)
...
--[[
	local function get_valleys_height(z,x,dim)
		...
		-- Mapgen parameters
		local river_size_factor = lib_mg_valleys_2d.mgvalleys_river_size / 100
		local water_level       = lib_mg_valleys_2d.water_level
...
--]]
	...
	minetest.register_on_generated(function(minp, maxp, seed)
		...
		local river_size_factor = lib_mg_valleys_2d.mgvalleys_river_size / 100
		local water_level       = lib_mg_valleys_2d.water_level
		local mg_dim = lib_mg_valleys_2d.mg_dim	
	...
	--## HEIGHTMAP CALCULATION
				...
				lib_mg_valleys_2d.heightmap[index2d] = t_y
	...
	--## RIVERS CALCULATION
				...
				lib_mg_valleys_2d.rivermap[index2d] = river_course

	--## FILLER CALCULATION

				--lib_mg_valleys_2d.fillermap[index2d] = nbuf_filler_depth[z-minp.z+1][x-minp.x+1]
				lib_mg_valleys_2d.fillermap[index2d] = nbuf_filler_depth[z-minp.z+1][x-minp.x+1] + nbuf_val_dirt[z-minp.z+1][x-minp.x+1]
	...
	--## 2D BIOME SELECTION
				...
				lib_mg_valleys_2d.biomemap[index2d] = get_biome_name(nheat,nhumid,t_y)
		...
		for z = minp.z, maxp.z do
			for y = minp.y, maxp.y do
				for x = minp.x, maxp.x do
					...
					local theight = lib_mg_valleys_2d.heightmap[index2d]
					local tfilldepth = lib_mg_valleys_2d.fillermap[index2d]
					local t_biome_name = lib_mg_valleys_2d.biomemap[index2d]
					local t_rivermap = lib_mg_valleys_2d.rivermap[index2d]
	...
	--## BIOME GENERATION
					...
					t_stone = lib_mg_valleys_2d.biome_info[t_biome_name].b_stone
					t_filler = lib_mg_valleys_2d.biome_info[t_biome_name].b_filler
					fill_depth = tfilldepth
					t_top = lib_mg_valleys_2d.biome_info[t_biome_name].b_top
					top_depth = 1
					t_water = lib_mg_valleys_2d.biome_info[t_biome_name].b_water
					t_river = lib_mg_valleys_2d.biome_info[t_biome_name].b_river
	...
	--## NODE PLACEMENT FROM HEIGHTMAP
				...
				--2D Terrain
					...
					elseif y >= (theight - top_depth) and y <= theight then
						...
						t_node = t_top
					elseif y > theight and y <= lib_mg_valleys_2d.water_level then
		...
		print ("[lib_mg_valleys_2d] Mapchunk generation time " .. chugent .. " ms")
		...
		if mem > 1000 then
			print("lib_mg_valleys_2d is manually collecting garbage as memory use has exceeded 500K.")
	...
	minetest.register_on_shutdown(function()
		...
		if lib_mg_valleys_2d.mg_add_voronoi == true then
			lib_mg_valleys_2d.save_neighbors()
		end
